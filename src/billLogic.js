...
const handleDataBill = () => {
  const rs = excelToJson({sourceFile: "data/thang3.xlsx", columnToKey: {
    A: 'chiNhanh',
    B: 'maHoaDon',
    C: 'thoiGian',
    D: 'maKhachHang',
...
const fetchHangHoa = async (branchId, maHangHoa) => {
  const response = await fetch(`https://taoden.mshopkeeper.vn/backendg1/api/InventoryItem?_dc=1740478058265&inventoryItemCategoryID=00000000-0000-0000-0000-000000000000&branchID=${branchId}&isOutStock=0&page=1&start=0&limit=50&sort=%5B%7B%22property%22%3A%22InventoryItemName%22%2C%22direction%22%3A%22ASC%22%7D%5D&filter=%5B%7B%22xtype%22%3A%22filter%22%2C%22isFilterRow%22%3Atrue%2C%22property%22%3A%22Inactive%22%2C%22operator%22%3A0%2C%22value%22%3A0%2C%22type%22%3A7%7D%2C%7B%22xtype%22%3A%22filter%22%2C%22isFilterRow%22%3Atrue%2C%22property%22%3A%22SKUCode%22%2C%22operator%22%3A1%2C%22value%22%3A${maHangHoa}%2C%22type%22%3A1%2C%22addition%22%3A1%2C%22group%22%3A%22SKUCodeFFR%22%7D%5D`, {
    "headers": {
      ...
      "Referer": "https://taoden.mshopkeeper.vn/main",
...
const fetchKhachHang = async (maKhachHang) => {
  const response = await fetch(`https://taoden.mshopkeeper.vn/backendg1/api/Customer?_dc=1740472948312&page=1&start=0&limit=50&filter=%5B%7B%22xtype%22%3A%22filter%22%2C%22isFilterRow%22%3Atrue%2C%22property%22%3A%22Inactive%22%2C%22operator%22%3A0%2C%22value%22%3A0%2C%22type%22%3A7%7D%2C%7B%22xtype%22%3A%22filter%22%2C%22isFilterRow%22%3Atrue%2C%22property%22%3A%22CustomerCode%22%2C%22operator%22%3A1%2C%22value%22%3A%22${maKhachHang}%22%2C%22type%22%3A1%2C%22addition%22%3A1%2C%22group%22%3A%22CustomerCodeFFR%22%7D%5D`, {
    "headers": {
      "accept": "application/json",
      "accept-language": "en-US,en;q=0.9,vi;q=0.8",
      "authorization": `Bearer ${token}`,
...
const saveBill = async (branchID,body, maHoaDon) => {
  const response = await fetch("https://taoden.mshopkeeper.vn/salecloud/uploadg1/SAInvoice/save-sync", {
    "headers": {
      ...
      "Referer": "https://taoden.mshopkeeper.vn/salecloudg1/",
      "Referrer-Policy": "strict-origin-when-cross-origin"
    },
